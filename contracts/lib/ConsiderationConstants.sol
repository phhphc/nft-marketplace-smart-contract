...
uint256 constant OrderParameters_counter_offset = 0x120;
...
uint256 constant EIP712_Order_size = 0x160;
...
uint256 constant OrderParameters_totalOriginalConsiderationItems_offset = (0x0120);
