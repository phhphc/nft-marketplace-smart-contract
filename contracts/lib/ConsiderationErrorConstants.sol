...
uint256 constant UnresolvedConsiderationCriteria_error_considerationIdx_ptr = (0x40);
 ...
 * Revert buffer is memory[0x1c:0x20]
 */
uint256 constant ConsiderationLengthNotEqualToTotalOriginal_error_selector = (0x2165628a);
